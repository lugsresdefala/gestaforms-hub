...
if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
  console.error('Erro: Configuração do Supabase não encontrada. Verifique as variáveis de ambiente VITE_SUPABASE_URL e VITE_SUPABASE_PUBLISHABLE_KEY');
}

// Cria o cliente Supabase com tratamento de erros robusto
