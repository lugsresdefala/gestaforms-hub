  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    try {
      ...
      let agendamentoData: any = {
        ...
        procedimentos,
        diagnosticos_maternos: diagnosticos.maternos.length > 0 ? diagnosticos.maternos.join(', ') : null,
        diagnosticos_fetais: diagnosticos.fetais.length > 0 ? diagnosticos.fetais.join(', ') : null,
        diagnostico_livre: (diagnosticos.maternos.length === 0 && diagnosticos.fetais.length === 0) ? row.diagnostico : null,
