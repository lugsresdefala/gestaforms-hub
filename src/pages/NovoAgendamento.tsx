  ...
  const salvarAgendamento = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const agendamentoData = {
        ...
        numero_gestacoes: parseInt(values.numeroGestacoes || "0"),
        numero_partos_cesareas: parseInt(values.numeroPartosCesareas || "0"),
        numero_partos_normais: parseInt(values.numeroPartosNormais || "0"),
        numero_abortos: parseInt(values.numeroAbortos || "0"),
